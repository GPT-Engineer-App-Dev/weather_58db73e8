...
const Index = () => {
  ...
  return (
    <Flex minH="100vh" alignItems="center" justifyContent="center" bgGradient={colorMode === "light" ? "linear(to-b, blue.300, blue.500)" : "linear(to-b, gray.700, gray.900)"}>
      <Box p={8} borderRadius="lg" boxShadow="lg" bg={colorMode === "light" ? "white" : "gray.800"} color={colorMode === "light" ? "gray.800" : "white"} maxW="md">
        ...
        {isLoading ? (
          ...
          <>
            <Flex alignItems="center" mb={4}>
              <Image src={`https://openweathermap.org/img/w/${weather.weather[0].icon}.png`} alt={weather.weather[0].description} boxSize="64px" mr={4} />
              <Box>
                <Heading size="xl">{Math.round(weather.main.temp)}°C</Heading>
            ...
            <IconButton aria-label="Search location" icon={<FaSearchLocation />} onClick={handleLocationSearch} />
          </>
        ) : (
